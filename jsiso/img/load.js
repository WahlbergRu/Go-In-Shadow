  ...
  define(function() {
    ...
    * @return {Promise.<Array>}          Returns images in an array for using once fulfilled
    ...
    return function(graphics) {
       ...
       */
      var _imgPromise, _splitSpriteSheet, i, promises;
      _splitSpriteSheet = function(spritesheet) {
        return new Promise(function(resolve, reject) {
          var ctx, i, imageFilePathArray, images, j, loaded, loading, spriteID, spritesheetCols, spritesheetRows, tileCol, tileManip, tileRow;
          loaded = 0;
          loading = 0;
          images = [];
          ...
          tileManip = void 0;
          imageFilePathArray = [];
          spriteID = spritesheet.firstgid || 0;
          tileRow = void 0;
          tileCol = void 0;
       ...
       */
      _imgPromise = function(graphic) {
        return new Promise(function(resolve, reject) {
          var i, images, loaded, loading, results;
          loaded = 0;
          loading = 0;
          images = [];
          ...
          graphic.graphics.map(function(img) {
            var imgName;
            imgName = img;
            if (graphic.removePath === void 0 || graphic.removePath === true) {
              imgName = img.split('/').pop();
            }
            images[imgName] = new Image;
            images[imgName].src = img;
            return images[imgName].onload = function() {
              loaded++;
